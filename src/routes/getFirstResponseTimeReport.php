...
$app->post('/api/HelpDesk/getFirstResponseTimeReport', function ($request, $response) {
    ...
    $optionalParams = ['previousStart'=>'previousStart','previousEnd'=>'previousEnd','mailboxes'=>'mailboxes','tags'=>'tags','types'=>'types','folders'=>'folders','officeHours'=>'officeHours','viewBy'=>'viewBy'];
    $bodyParams = [
       'query' => ['start','end','previousStart','previousEnd','mailboxes','tags','types','folders','officeHours','viewBy']
    ];
    ...
    $query_str = "https://api.helpscout.net/v1/reports/productivity/first-response-time.json";
