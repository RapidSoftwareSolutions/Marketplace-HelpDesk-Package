...
$app->post('/api/HelpDesk/getUserUserDrillDownReport', function ($request, $response) {
    ...
    $optionalParams = ['previousStart'=>'previousStart','previousEnd'=>'previousEnd','mailboxes'=>'mailboxes','tags'=>'tags','types'=>'types','folders'=>'folders','page'=>'page','rows'=>'rows'];
    $bodyParams = [
       'query' => ['start','end','previousStart','previousEnd','mailboxes','tags','types','folders','page','rows']
    ];
    ...
    $query_str = "https://api.helpscout.net/v1/reports/users/drilldown.json";
