...
$app->post('/api/HelpDesk/getHappinessOverallReport', function ($request, $response) {
    ...
    $optionalParams = ['previousStart'=>'previousStart','previousEnd'=>'previousEnd','mailboxes'=>'mailboxes','tags'=>'tags','folders'=>'folders','types'=>'types'];
    $bodyParams = [
       'query' => ['start','end','previousStart','previousEnd','mailboxes','tags','types','folders','types']
    ];
    ...
    $query_str = "https://api.helpscout.net/v1/reports/happiness.json";
