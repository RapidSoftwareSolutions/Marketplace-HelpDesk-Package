...
$app->post('/api/HelpDesk/getDocsReport', function ($request, $response) {
    ...
    $optionalParams = ['previousStart'=>'previousStart','previousEnd'=>'previousEnd','sites'=>'sites'];
    $bodyParams = [
       'query' => ['start','end','previousStart','previousEnd','sites']
    ];
    ...
    $data['sites'] = \Models\Params::toString($data['sites'], ','); 

    $client = $this->httpClient;
    $query_str = "https://api.helpscout.net/v1/reports/docs.json";
