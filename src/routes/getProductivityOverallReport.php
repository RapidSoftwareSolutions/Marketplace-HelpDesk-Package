...
$app->post('/api/HelpDesk/getProductivityOverallReport', function ($request, $response) {
    ...
    $bodyParams = [
       'query' => ['start','end','previousStart','previousEnd','mailboxes','tags','types','folders','officeHours']
    ];
    ...
    $query_str = "https://api.helpscout.net/v1/reports/productivity.json";
