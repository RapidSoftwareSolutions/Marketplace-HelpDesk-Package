...
$app->post('/api/HelpDesk/getUserReport', function ($request, $response) {
    ...
    $optionalParams = ['previousStart'=>'previousStart','previousEnd'=>'previousEnd','mailboxes'=>'mailboxes','tags'=>'tags','types'=>'types','folders'=>'folders','officeHours'=>'officeHours'];
    $bodyParams = [
       'query' => ['start','end','previousStart','previousEnd','mailboxes','tags','types','folders','officeHours','user']
    ];
    ...
    $query_str = "https://api.helpscout.net/v1/reports/user.json";
