...
$app->post('/api/HelpDesk/getBusiestDayTimeReport', function ($request, $response) {
    ...
    $optionalParams = ['previousStart'=>'previousStart','previousEnd'=>'previousEnd','mailboxes'=>'mailboxes','tags'=>'tags','folders'=>'folders'];
    $bodyParams = [
       'query' => ['start','end','previousStart','previousEnd','mailboxes','tags','types','folders']
    ];
    ...
    $query_str = "https://api.helpscout.net/v1/reports/conversations/busy-times.json";
