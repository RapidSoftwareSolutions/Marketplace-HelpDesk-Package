...
$app->post('/api/HelpDesk/getProductivityDrillDownReport', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','start','end','range']);
    ...
    $query_str = "https://api.helpscout.net/v1/reports/productivity/drilldown.json";
