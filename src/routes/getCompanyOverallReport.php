...
$app->post('/api/HelpDesk/getCompanyOverallReport', function ($request, $response) {
    ...
    $optionalParams = ['previousStart'=>'previousStart','previousEnd'=>'previousEnd','mailboxes'=>'mailboxes','tags'=>'tags','types'=>'types','folders'=>'folders'];
    $bodyParams = [
    ...
    $query_str = "https://api.helpscout.net/v1/reports/company.json";
