...
$app->post('/api/HelpDesk/getFieldDrillDownReport', function ($request, $response) {
    ...
    $query_str = "https://api.helpscout.net/v1/reports/conversations/fields-drilldown.json";
